...
## 配套工具
<!-- TODO:commitlint npm包 -->
- [@fe-spec/commitlint-config](https://www.npmjs.com/package/commitlint-config-ali)：本规范配套的 [commitlint](https://github.com/conventional-changelog/commitlint) 配置包，可用于校验 commit message。
