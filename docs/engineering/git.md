...
- [commitlint-config-toolkit](https://www.npmjs.com/package/commitlint-config-toolkit)：本规范配套的 [commitlint](https://github.com/conventional-changelog/commitlint) 配置包，可用于校验 commit message。
